...
const PRS: TrackedPR[] = [
  { owner: 'a', repo: 'b', number: 1, title: 'one', authorLogin: 'x', status: 'untouched', ghStatus: 'open', ciStatus: null, ciUrl: null, createdAt: null, addedAt: 1 },
  { owner: 'a', repo: 'b', number: 2, title: 'two', authorLogin: 'x', status: 'untouched', ghStatus: 'open', ciStatus: null, ciUrl: null, createdAt: null, addedAt: 2 },
];
