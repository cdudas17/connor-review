...
const PRS: TrackedPR[] = [
  { owner: 'a', repo: 'b', number: 1, title: 'First', authorLogin: 'alice', status: 'untouched', ghStatus: 'open', ciStatus: 'SUCCESS', addedAt: 1 },
  { owner: 'a', repo: 'b', number: 2, title: 'Second', authorLogin: 'bob', status: 'reviewed', ghStatus: 'open', ciStatus: 'PENDING', addedAt: 2 },
  { owner: 'a', repo: 'b', number: 3, title: 'Third', authorLogin: 'carol', status: 'approved', ghStatus: 'merged', ciStatus: 'SUCCESS', addedAt: 3 },
];
